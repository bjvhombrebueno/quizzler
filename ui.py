...
class QuizInterface:
    ...
    def __init__(self, quiz:QuizBrain):
        ...
        self.score_label = Label( text="Score:", fg="white", font=("Arial", 10), bg=THEME_COLOR)
        self.score_label.grid(row =0,column=1)
        self.canvas = Canvas(width=300,height=250,highlightthickness=0, bg="white")
        self.question_text = self.canvas.create_text(150, 125, width=280, text="French", fill="black", font=("Arial", 20, "italic"))
